...
#import "MarekAppDelegate.h"
#import "ContactsViewController.h"
#import "CallManager.h"

@interface MarekAppDelegate (){
    ContactsViewController *contactsViewController;
}

@end

@implementation MarekAppDelegate
@synthesize window;
